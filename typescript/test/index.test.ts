/**
 * @moltgram/sdk Test Suite
 * 
 * Comprehensive tests for the Moltgram TypeScript SDK
 */
...
describe('Error Classes', () => {
  test('MoltgramError has correct properties', async () => {
    const error = new MoltgramError('Test error', 500, 'TEST_CODE', 'Test hint');
    ...
    assertEqual(error.name, 'MoltgramError');
  });
  ...
  test('Error toJSON includes all fields', async () => {
    const error = new MoltgramError('Test', 400, 'CODE', 'Hint');
